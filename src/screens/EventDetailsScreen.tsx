...
// Import DetailDisplayItem
import { DetailDisplayItem } from '../components/ui';
    ...
    >
      ...
      >
        <Section title="Informações Básicas" theme={theme} style={styles.sectionSpacing}>
          {isReadOnlyMode ? (
            <>
              <DetailDisplayItem label="Título" value={formData.title} iconName="format-title" fullWidthValue isReadOnly />
              <DetailDisplayItem label="Tipo" value={getEventTypeLabel(formData.eventType)} iconName="tag-outline" isReadOnly />
              <DetailDisplayItem
                label="Data"
              ...
              <DetailDisplayItem label="Dia Todo" value={formData.isAllDay} iconName="calendar-check" isReadOnly />
              <DetailDisplayItem label="Local" value={formData.local} iconName="map-marker-outline" fullWidthValue isReadOnly />
              <DetailDisplayItem label="Cor" value={formData.cor} iconName="palette-outline" isReadOnly />
            </>
          ) : (
            <>
              <Input
        ...
        <Section title="Detalhes Adicionais" theme={theme} style={styles.sectionSpacing}>
          {isReadOnlyMode ? (
            <>
              <DetailDisplayItem label="Nº Processo" value={formData.numeroProcesso} iconName="gavel" isReadOnly />
              <DetailDisplayItem label="Vara/Comarca" value={formData.vara} iconName="bank-outline" isReadOnly />
              <DetailDisplayItem label="Prioridade" value={formData.prioridade ? PRIORIDADE_LABELS[formData.prioridade] : undefined} iconName="priority-high" isReadOnly />
              <DetailDisplayItem label="Status" value={formData.status ? getEventStatusLabel(formData.status) : undefined} iconName="list-status" isReadOnly />
            </>
          ) : (
            <>
              <Input
        ...
        <Section title="Lembretes" theme={theme} style={styles.sectionSpacing}>
          {isReadOnlyMode ? (
            <DetailDisplayItem label="Lembretes" value={formatDisplayReminders(formData.reminders)} iconName="bell-ring-outline" fullWidthValue isReadOnly />
          ) : (
            <>
        ...
        <Section title="Descrição / Observações" theme={theme} style={styles.sectionSpacing}>
          {isReadOnlyMode ? (
            <DetailDisplayItem label="Descrição" value={formData.description} iconName="text-long" fullWidthValue isReadOnly />
          ) : (
            <Input
...
// Local DetailItemView component removed as it's replaced by shared DetailDisplayItem.
