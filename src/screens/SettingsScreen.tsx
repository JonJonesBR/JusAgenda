...
const SettingsScreen = () => {
  ...
  const loadSettings = async () => {
    try {
      ...
      const emailNotificationsValue = await AsyncStorage.getItem(
        SETTINGS_KEYS.EMAIL_NOTIFICATIONS
      );
      setEmailNotifications(emailNotificationsValue === "true");

      const defaultEmailValue = await AsyncStorage.getItem(
        SETTINGS_KEYS.DEFAULT_EMAIL
      );
      if (defaultEmailValue) setDefaultEmail(defaultEmailValue);

      const reminderTimeValue = await AsyncStorage.getItem(
        SETTINGS_KEYS.DEFAULT_REMINDER_TIME
      );
  ...
  const toggleEmailNotifications = async (value: boolean) => {
    ...
    // );
      ...
      console.error(
        "Erro ao alterar configuração de notificações por email:",
        error instanceof Error ? error.message : String(error)
      );
    }
  };
    ...
    <ScrollView style={styles.container}>
      <Card containerStyle={styles.sectionCard}>
        ...
        >
          <Icon
            name="alarm"
            color={notificationsEnabled ? theme.colors.primary : "#CCCCCC"}
          />
          <ListItem.Content>
            <ListItem.Title
              style={[
          ...
          <Icon
            name="chevron-right"
            color={
              notificationsEnabled ? theme.colors.textSecondary : "#CCCCCC"
            }
          />
        </ListItem>
        ...
        >
          <Icon
            name="email"
            color={isEmailAvailable ? theme.colors.primary : "#CCCCCC"}
          />
          <ListItem.Content>
            <ListItem.Title
              style={[
        ...
        >
          <Icon
            name="contact-mail"
            color={
              isEmailAvailable && emailNotifications
      ...
      <Card containerStyle={styles.sectionCard}>
        ...
        <View style={styles.aboutSection}>
          ...
          <Text style={styles.appDescription}>
            Assistente para advogados organizarem prazos, audiências, reuniões e
            muito mais.
          </Text>
