          ...
          <View style={[styles.filterModal, { backgroundColor: currentTheme.card }]}>
            ...
            {filters.map(filter => (
              <TouchableOpacity key={filter} style={styles.filterOption} onPress={() => toggleFilter(filter)} >
                ...
                <View style={[styles.checkbox, { backgroundColor: selectedFilters[filter] ? currentTheme.primary : 'transparent', borderColor: currentTheme.primary }]}>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity style={styles.modalButton} onPress={() => { handleSearchSubmit(); setFilterModalVisible(false); }} >
