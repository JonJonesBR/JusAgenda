...
export const formatarNumeroProcesso = (numero) => {
  ...
  return `${numerosApenas.substring(0, 7)}-${numerosApenas.substring(7, 9)}.${numerosApenas.substring(9, 13)}.${numerosApenas.substring(13, 14)}.${numerosApenas.substring(14, 16)}.${numerosApenas.substring(16, 20)}`;
};
